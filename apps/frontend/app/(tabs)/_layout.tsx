  ...
  return (
    <>
      <Tabs
        screenOptions={{
          headerShown: false,
          tabBarActiveTintColor: "#4CAF50", // eslint-disable-line no-restricted-syntax
          tabBarInactiveTintColor: isDark ? "#888888" : "#999999", // eslint-disable-line no-restricted-syntax
          tabBarLabelStyle: {
            fontSize: 11,
          ...
          tabBarStyle: {
            backgroundColor: isDark ? "#1A1A1A" : "#FFFFFF", // eslint-disable-line no-restricted-syntax
            borderTopWidth: 1,
            borderTopColor: isDark ? "#333333" : "#F0F0F0", // eslint-disable-line no-restricted-syntax
            height: 65,
            paddingTop: 5,
          },
        }}
      ...
      >
        <TouchableOpacity
          ...
          style={{
            ...
            height: 60,
            borderRadius: 30,
            backgroundColor: "#FFC107", // eslint-disable-line no-restricted-syntax
            justifyContent: "center",
            alignItems: "center",

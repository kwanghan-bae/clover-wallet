...
describe("HistoryItem", () => {
  ...
  it("calls onDelete when delete button is pressed and confirmed", () => {
    ...
    const deleteButton = alertButtons!.find((b) => b.style === "destructive");
    expect(deleteButton).toBeDefined();
    expect(deleteButton?.onPress).toBeDefined();

    // Trigger the delete confirmation manually
    deleteButton!.onPress!();

    // Ensure the actual onDelete callback is fired

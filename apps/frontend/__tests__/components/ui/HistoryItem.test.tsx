...
describe("HistoryItem", () => {
  ...
  it("shows confirmation dialog and calls onDelete when confirmed", () => {
    ...
    // 2. Verify Alert.alert was called with correct arguments
    ...
    // 3. Extract the buttons array from the mock call
    const buttons = alertSpy.mock.calls[0][2] as
      | Array<{ text: string; onPress?: () => void }>
      | undefined;

    // 4. Find and press the confirm button
    ...
    // 5. Verify the actual onDelete handler was called

...
jest.mock("./components/ui/LuckyHeroIllustration", () => {
  ...
  const LuckyHeroIllustration = () =>
    React.createElement(View, { testID: "hero-illustration" });
  return {
    __esModule: true,
    default: LuckyHeroIllustration,
...
jest.mock("expo-blur", () => ({
  BlurView: (props) => require("react").createElement("View", props),
}));

...
## 2026-06-02 - Alert Confirmation for Destructive List Actions
**Learning:** In React Native, list items with destructive actions (like a delete button) often use `hitSlop` to increase the tap area, making accidental taps highly likely during scrolling or navigation.
**Action:** Always wrap list item delete actions in an `Alert.alert` confirmation dialog to prevent accidental data loss.

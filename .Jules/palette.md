...
## 2024-03-24 - Destructive Actions and hitSlop
**Learning:** Destructive actions (like delete buttons) in list items are prone to accidental taps, especially when `hitSlop` is used to increase the touch target size for accessibility.
